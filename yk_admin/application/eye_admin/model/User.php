...
class User extends Model{
	function getB1(){
		$items =$this->alias("i")->field("i.id,i.type,i.headimg,i.nickname,i.tel,i.true_name,i.time,i.goods_price,i.profit,i.totalprofit")
		->where('type',1)
		->order('i.time desc')
		->select();
		return $items;
	...
	function getB1_2(){
		$items =$this->alias("i")->field("i.id,i.type,i.headimg,i.nickname,i.tel,i.true_name,i.time,i.goods_price,i.profit,i.totalprofit,i.addr,i.unit,u.nickname unickname")
	...
	function getB2_1(){
		$items =$this->alias("i")->field("i.type,i.id,i.type,i.headimg,i.nickname,i.tel,i.true_name,i.time,i.goods_price,i.profit,i.totalprofit,i.addr,i.unit,u.nickname unickname")
		->join("user u","i.up_uid=u.id","left")
		->where('i.type',3)
		->order('i.time desc')
		->select();
	...
	function getC1(){
		$items =$this->alias("i")->field("i.id,i.type,i.headimg,i.nickname,i.tel,i.true_name,i.time,i.consume,i.addr,i.unit,u.nickname unickname")
		->join("user u","i.up_uid=u.id","left")
		->where('i.type',5)
		->order('i.time desc')
		->select();
